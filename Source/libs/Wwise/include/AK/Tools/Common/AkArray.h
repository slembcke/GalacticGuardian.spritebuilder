...
template <class T, class ARG_T, class TAlloc = ArrayPoolDefault, unsigned long TGrowBy = 1> class AkArray : public TAlloc
{
public:
	/// Constructor
	AkArray()
...
#pragma warning( pop )
	...
	void Transfer(AkArray<T,ARG_T,TAlloc,TGrowBy>& in_rSource)
	{
		if (m_pItems)
			Term();
