...
// NOTE : 
template <class T_KEY, class T_ITEM, class U_POOL = ArrayPoolDefault, AkUInt32 TGrowBy = 1 > 
class CAkKeyArray : public AkArray< MapStruct<T_KEY, T_ITEM>, const MapStruct<T_KEY, T_ITEM>&, U_POOL, TGrowBy>
{
public:
//====================================================================================================
...
//====================================================================================================
	...
	{
		typename CAkKeyArray< T_KEY, T_ITEM, U_POOL, TGrowBy >::Iterator it = this->FindEx( in_Key );
...
//====================================================================================================
	...
	typename AkArray< MapStruct<T_KEY, T_ITEM>, const MapStruct<T_KEY, T_ITEM>&, U_POOL, TGrowBy>::Iterator FindEx( T_KEY in_Item ) const
	{
		typename CAkKeyArray< T_KEY, T_ITEM, U_POOL, TGrowBy >::Iterator it = this->Begin();

		typename CAkKeyArray< T_KEY, T_ITEM, U_POOL, TGrowBy >::Iterator itEnd = this->End();
		for ( ; it != itEnd; ++it )
		{
			if ( (*it).key == in_Item )
				break;
...
//====================================================================================================
	...
	{
		typename CAkKeyArray< T_KEY, T_ITEM, U_POOL, TGrowBy >::Iterator it = FindEx( in_Key );
		if( it != this->End() )
		{
			this->Erase( it );
		}
...
template <class T_KEY, class T_ITEM, class U_POOL, class U_KEY = AkGetArrayKey< T_KEY, T_ITEM >, unsigned long TGrowBy = 1> 
class AkSortedKeyArray : public AkArray< T_ITEM, const T_ITEM &, U_POOL, TGrowBy >
{
public:
	...
	void Unset( P_KEY in_key )
	{
		...
		if ( bFound )
		{
			typename AkArray< T_ITEM, const T_ITEM &, U_POOL, TGrowBy >::Iterator it;
			it.pItem = pItem;
			this->Erase( it );
		}
	}
