...
#pragma once
	...
	#define AKSIMD_GETELEMENT_V4I32( __vName, __num__ )			((AKSIMD_V4I32)__vName).n128_i32[(__num__)]	///< Retrieve scalar element from vector.
	#define AKSIMD_GETELEMENT_V4F32( __vName, __num__ )			((AKSIMD_V4F32)__vName).n128_f32[(__num__)]	///< Retrieve scalar element from vector.
	#define AKSIMD_GETELEMENT_V2F32( __vName, __num__ )			((AKSIMD_V2F32)__vName).n64_f32[(__num__)]	///< Retrieve scalar element from vector.
