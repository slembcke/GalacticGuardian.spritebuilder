...
// iZTrashMultibandDistortionFXFactory.h

/// \file
/// Plug-in unique ID and creation functions (hooks) necessary to register the plug-in in the sound engine.
/// <br><b>Wwise effect name:</b>  iZotope Trash Multiband Distortion
/// <br><b>Library file:</b> iZTrashMultibandDistortionFX.lib

#ifndef _AK_TRASHMULTIBANDDISTORTIONFXFACTORY_H_
#define _AK_TRASHMULTIBANDDISTORTIONFXFACTORY_H_
...
/// \endakwarning
const unsigned long IZEFFECTID_TRASHMULTIBANDDISTORTION = 9;
...
AK_FUNC( AK::IAkPluginParam *, CreateTrashMultibandDistortionFXParams )(
...
AK_FUNC( AK::IAkPlugin*, CreateTrashMultibandDistortionFX )(
	AK::IAkPluginMemAlloc * in_pAllocator			///< Memory allocator interface
	);
